...
CREATE TABLE `usershop` (
  ...
  CONSTRAINT `usershop_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`),
  CONSTRAINT `usershop_ibfk_2` FOREIGN KEY (`ShopID`) REFERENCES `shop` (`ShopID`)
