...
<html><head>
    ...
    <div>
      <div class="container bcontainer">
          ...
          <div class="col-md-12 ">
            <div class="row ">
              ...
              <div class="col-md-6 text-right">
                <a class="btn btn-primary" style="margin-top: 25px; border-radius: 8px"><i class="fa fa-fw fa-lg fa-plus"></i>Aggiungi nuovo indirizzo</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <a class="btn btn-primary" style="height: 50px; background-color: grey; float: right; font-size: 20px; border-radius: 8px">Indietro</a>
          </div>
          <div class="col-md-6">
            <a class="btn btn-primary" style="height: 50px; background-color: #99CC33; font-size: 20px; border-radius: 8px">Prosegui</a>
          </div>
        </div>
      </div>
    </div>
